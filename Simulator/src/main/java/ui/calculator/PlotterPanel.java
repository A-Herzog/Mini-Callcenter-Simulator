...
public class PlotterPanel extends JPanel {
	...
	public PlotterPanel() {
		...
		addToolbarIcon(toolbar,Language.tr("CalculatorDialog.Plotter.Toolbar.Copy"),Language.tr("CalculatorDialog.Plotter.Toolbar.Copy.Hint"),Images.COPY.getIcon(),e->copyToClipboard());
		addToolbarIcon(toolbar,Language.tr("CalculatorDialog.Plotter.Toolbar.Print"),Language.tr("CalculatorDialog.Plotter.Toolbar.Print.Hint"),Images.MODEL_PRINT.getIcon(),e->print());
		addToolbarIcon(toolbar,Language.tr("CalculatorDialog.Plotter.Toolbar.Save"),Language.tr("CalculatorDialog.Plotter.Toolbar.Save.Hint"),Images.MODEL_SAVE.getIcon(),e->save());
	...
	public static class Graph {
		/**
		 * Name der Variable für {@link CalcSystem}
		 */
		...
		private double[] getMinMax(final double xMin, final double xMax, final int steps) {
			...
			final CalcSystem calc=getParser();
