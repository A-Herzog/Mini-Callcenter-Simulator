...
public class Statistics extends StatisticsBase {
	...
	public Statistics(final boolean collectCorrelation, final boolean useWelford) {
		...
		addPerformanceIndicator(interarrivalTime=new StatisticsDataPerformanceIndicator(Language.trAll("Statistics.XML.InterArrivalTimes"),7200,7200,-1,StatisticsDataPerformanceIndicator.CORRELATION_RANGE_STEPPING_DEFAULT,1,useWelford));
		addPerformanceIndicator(interleaveTime=new StatisticsDataPerformanceIndicator(Language.trAll("Statistics.XML.InterLeaveTimes"),7200,7200,-1,StatisticsDataPerformanceIndicator.CORRELATION_RANGE_STEPPING_DEFAULT,1,useWelford));
		addPerformanceIndicator(waitingTimeAll=new StatisticsDataPerformanceIndicator(Language.trAll("Statistics.XML.WaitingTimesAll"),7200,7200,correlationRange,StatisticsDataPerformanceIndicator.CORRELATION_RANGE_STEPPING_DEFAULT,1,useWelford));
		addPerformanceIndicator(waitingTimeSuccess=new StatisticsDataPerformanceIndicator(Language.trAll("Statistics.XML.WaitingTimesSuccess"),7200,7200,-1,StatisticsDataPerformanceIndicator.CORRELATION_RANGE_STEPPING_DEFAULT,1,useWelford));
		addPerformanceIndicator(waitingTimeCancel=new StatisticsDataPerformanceIndicator(Language.trAll("Statistics.XML.WaitingTimesCancel"),7200,7200,-1,StatisticsDataPerformanceIndicator.CORRELATION_RANGE_STEPPING_DEFAULT,1,useWelford));
		addPerformanceIndicator(workingTime=new StatisticsDataPerformanceIndicator(Language.trAll("Statistics.XML.WorkingTimes"),7200,7200,-1,StatisticsDataPerformanceIndicator.CORRELATION_RANGE_STEPPING_DEFAULT,1,useWelford));
		addPerformanceIndicator(postProcessingTime=new StatisticsDataPerformanceIndicator(Language.trAll("Statistics.XML.PostProcessingTime"),7200,7200,-1,StatisticsDataPerformanceIndicator.CORRELATION_RANGE_STEPPING_DEFAULT,1,useWelford));
		addPerformanceIndicator(systemTimeAll=new StatisticsDataPerformanceIndicator(Language.trAll("Statistics.XML.SystemTimeAll"),7200,7200,-1,StatisticsDataPerformanceIndicator.CORRELATION_RANGE_STEPPING_DEFAULT,1,useWelford));
		addPerformanceIndicator(systemTimeSuccess=new StatisticsDataPerformanceIndicator(Language.trAll("Statistics.XML.SystemTimeSuccess"),7200,7200,-1,StatisticsDataPerformanceIndicator.CORRELATION_RANGE_STEPPING_DEFAULT,1,useWelford));
