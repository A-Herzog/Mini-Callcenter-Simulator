...
!define PrgName "Mini Callcenter Simulator"
!define SetupFileName "MiniCallcenterSimulatorSetup.exe"
!define RegKey "Mini Callcenter Simulator"
...
!define PROGEXE "MiniCallcenterSimulator.exe"
...
LangString LANGNAME_FinishTitle ${LANG_GERMAN} "Installation des Mini Callcenter Simulators abgeschlossen"
LangString LANGNAME_FinishText ${LANG_GERMAN} "Der Mini Callcenter Simulator wurde auf Ihrem Computer installiert.$\r$\n$\r$\nKlicken Sie auf Fertig stellen, um dieses Installationsprogramm zu schließen."
LangString LANGNAME_FinishRun ${LANG_GERMAN} "Mini Callcenter Simulator jetzt starten"
LangString LANGNAME_LinkUninstall ${LANG_GERMAN} "Mini Callcenter Simulator deinstallieren oder Konfiguration zurücksetzen"
LangString LANGNAME_UninstallWarning ${LANG_GERMAN} "Das Installationsverzeichnis enthält Dateien, die nicht vom Mini Callcenter Simulator stammen. Soll das Verzeichnis dennoch vollständig gelöscht werden?"
...
LangString LANGNAME_FinishTitle ${LANG_ENGLISH} "Installation of Mini Callcenter Simulator completed"
LangString LANGNAME_FinishText ${LANG_ENGLISH} "The Mini Callcenter Simulator was installed on your computer.$\r$\n$\r$\nClick Finish to close this installer."
LangString LANGNAME_FinishRun ${LANG_ENGLISH} "Run Mini Callcenter Simulator now"
LangString LANGNAME_LinkUninstall ${LANG_ENGLISH} "Uninstall Mini Callcenter Simulator or reset configuration"
LangString LANGNAME_UninstallWarning ${LANG_ENGLISH} "The installation folder contains files which are not installed with Mini Callcenter Simulator. Do you want to delete this folder anyway?"
...
Section "Install" Inst
  ...
  IfFileExists "$INSTDIR\MiniCallcenterSimulator.cfg" ContinueInstall
    FileOpen $9 "$INSTDIR\MiniCallcenterSimulator.cfg" w
